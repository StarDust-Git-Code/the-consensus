...
const ResetModal: React.FC<ResetModalProps> = ({ isOpen, onClose, onConfirm }) => {
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
      ...
      />
      <div
        className="relative w-full max-w-md rounded-4xl shadow-2xl overflow-hidden border"
        ...
        <div className="px-8 pt-8 pb-10">
          <div className="flex items-start justify-between mb-8">
            <div className="flex items-center gap-4">
              ...
              <h3 className="text-2xl font-black text-darkConsensus leading-tight">
                Start New Project?
              </h3>
            </div>
            <button
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              className="w-full py-4 bg-darkConsensus hover:bg-darkConsensus text-white rounded-2xl font-black text-xs uppercase tracking-widest transition-all active:scale-[0.98] flex items-center justify-center gap-2"
            >
              <RefreshCcw size={14} />
