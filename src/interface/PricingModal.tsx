...
const PricingModal: React.FC<PricingModalProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center p-6 pointer-events-auto overflow-hidden">
      ...
      />
      <div
        className="relative w-full max-w-4xl rounded-[40px] shadow-[0_32px_64px_-12px_rgba(0,0,0,0.4)] p-8 md:p-12 border max-h-[90vh] overflow-y-auto"
      ...
      >
        ...
        <div className="mx-auto">
          ...
          <div className="mb-10 text-center">
            <h2 className="text-3xl font-black text-darkConsensus tracking-tight mb-2">
              Gemini API Pricing
            </h2>
                    ...
                    return (
                      <div key={model} className={`relative px-5 py-3.5 rounded-2xl border transition-all duration-300 flex items-center justify-between ${
                        ...
                        <div className="flex items-center gap-3 min-w-0 flex-1">
                          <p className="text-xs font-bold text-darkConsensus lowercase">
                            {model}
                          </p>
                        ...
                        <div className="flex items-center gap-5 text-xs font-mono font-bold">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-darkConsensus">${pricing.inputPer1M?.toFixed(2)}</span>
                          </div>
                          <div className="flex items-center gap-2">
                            <span className="text-zinc-400 font-medium uppercase text-[10px] tracking-tighter">Out</span>
                            <span className="text-darkConsensus">${pricing.outputPer1M?.toFixed(2)}</span>
                          </div>
                        </div>
                      </div>
                    );
                        ...
                        return (
                          <div key={model} className={`relative px-5 py-3.5 rounded-2xl border transition-all duration-300 flex items-center justify-between ${
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <span className="text-sm font-mono font-bold text-darkConsensus">
