...
export const TeamsPanel: React.FC<TeamsPanelProps> = ({ onSelectTeam, selectedTeamId, onModeChange, mode }) => {
  ...
  return (
    <div className="w-96 border-l flex flex-col h-full shrink-0" style={{ backgroundColor: 'var(--bg-elevated)', borderColor: 'var(--border-subtle)' }}>
      ...
      <div className="p-4 border-t" style={{ backgroundColor: 'var(--bg-elevated)', borderColor: 'var(--border-subtle)' }}>
        <button
          onClick={handleCreateNew}
          className="w-full flex items-center justify-center gap-2 py-3 rounded-xl text-[10px] font-black uppercase tracking-[0.1em] transition-all border hover:bg-zinc-800 active:scale-[0.98]"
