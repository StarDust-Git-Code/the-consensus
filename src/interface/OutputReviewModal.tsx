...
export function OutputReviewModal() {
    ...
    <div className="grid grid-cols-2 gap-4">
      <div className="space-y-2">
        ...
        <select
          ...
          className="w-full bg-white border border-zinc-200 rounded-xl px-3 py-2 text-xs focus:ring-2 focus:ring-darkConsensus outline-none"
        >
    ...
    return (
      <div className="space-y-2">
        ...
        <select
          ...
          className="w-full bg-white border border-zinc-200 rounded-xl px-3 py-2 text-xs font-medium focus:ring-2 focus:ring-darkConsensus outline-none"
        >
          {models.map(m => (
  ...
  return (
    <div
      className="fixed inset-0 z-[110] flex items-center justify-center bg-darkConsensus/40 backdrop-blur-md p-4"
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-8 py-6 border-b border-zinc-100 bg-white">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-2xl bg-darkConsensus flex items-center justify-center text-white shadow-lg">
              <Icon size={24} />
            </div>
            <div>
              <h2 className="text-sm font-black uppercase tracking-widest text-darkConsensus flex items-center gap-2">
        ...
        <div className="flex-1 overflow-y-auto px-8 py-8 space-y-8 bg-zinc-50/30">
          ...
          <div className="space-y-3">
            ...
            <textarea
              ...
              className="w-full h-40 bg-white border border-zinc-200 rounded-2xl p-4 text-sm text-zinc-700 leading-relaxed font-sans focus:ring-2 focus:ring-darkConsensus outline-none resize-none shadow-sm"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-darkConsensus rounded-[24px] p-6 text-white space-y-4 shadow-xl">
        ...
        <div className="px-8 py-6 border-t border-zinc-100 flex justify-end items-center bg-white gap-3">
          ...
          <button
            ...
            className="px-8 py-3 bg-darkConsensus text-white rounded-2xl text-[10px] font-black uppercase tracking-[0.15em] hover:bg-black active:scale-[0.98] transition-all shadow-lg shadow-black/10 flex items-center gap-2"
          >
      ...
      {isConfirmingReset && (
        <div
          className="fixed inset-0 z-[120] flex items-center justify-center bg-darkConsensus/40 backdrop-blur-md p-4 cursor-default"
          onClick={(e) => {
            e.stopPropagation()
            setIsConfirmingReset(false)
          }}
        >
          ...
          >
            ...
            <div>
              <h3 className="text-sm font-black uppercase tracking-widest text-darkConsensus">Are you absolutely sure?</h3>
